...
public class FireHigherWritable implements WritableComparable<FireHigherWritable> {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(that.temperatura, temperatura) == 0 && Objects.equals(mes, that.mes);
    }
    ...
    // método que realiza o comparativo entre diferentes objetos na etapa de sort/shuffle
    // para a ordenação de acordo com as chaves
    // dado 2 objetos, comparar se um é maior que o outro, menor ou igual com base no hashCode (valores dos atributos)
    @Override

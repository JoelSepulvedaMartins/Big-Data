...
public class HigherAverageTemperature {
    ...
    public static class MapForHigherAverage extends Mapper<LongWritable, Text, Text, FireHigherWritable>{
        public void map(LongWritable key, Text value, Context con) throws IOException, InterruptedException {

            // pega o conteudo da linha do arquivo gerado pela primeira rotina MapReduce
            String linha = value.toString();
    ...
    public static class ReduceForHigherAverage extends Reducer<Text, FireHigherWritable, Text, FloatWritable> {
        public void reduce(Text key, Iterable<FireHigherWritable> values, Context con) throws IOException, InterruptedException {
